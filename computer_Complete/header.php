        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-5">
                    <a href="http://localhost/ducthanh">
                    ...
                    <div class="menu-groups home d-none d-md-block">
                        <ul id="menu-main-menu" class="main-menu">
                            <li id="menu-item-31"
                                ...
                                <a href="<?php bloginfo('url'); ?>/category/laptop/">Laptop</a>
                                <ul class="sub-menu">
                                    <li id="menu-item-90"
                                        class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-90">
                                        <a href="<?php bloginfo('url'); ?>/category/laptop/laptop-moi/">Laptop
                                            mới</a>
                                    </li>
                                    <li id="menu-item-89"
                                        class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-89">
                                        <a href="<?php bloginfo('url'); ?>/category/laptop/laptop-cu/">Laptop
                                            cũ</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li id="menu-item-32"
                                ...
                                <a href="<?php bloginfo('url'); ?>/category/man-hinh/">Màn hình</a>
                                <ul class="sub-menu">
                                    <li id="menu-item-112"
                                        class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-112">
                                        <a href="<?php bloginfo('url'); ?>/category/man-hinh/man-hinh-moi/">Màn
                                            hình mới</a>
                                    </li>
                                    <li id="menu-item-111"
                                        class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-111">
                                        <a href="<?php bloginfo('url'); ?>/category/man-hinh/man-hinh-cu/">Màn
                                            hình cũ</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li id="menu-item-30"
                                class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-30"><a
                                    href="<?php bloginfo('url'); ?>/category/gears/">GEARS</a></li>
                            <li id="menu-item-28"
                                class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-28"><a
                                    href="<?php bloginfo('url'); ?>/category/ban-ghe-gaming/">Bàn ghế
                                    Gaming</a></li>
                            <li id="menu-item-29"
                                class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-29"><a
                                    href="<?php bloginfo('url'); ?>/category/camera/">Camera</a></li>
                        </ul>
                    </div>
            </div>
                ...
                <div id="header-slider" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?php echo get_theme_file_uri('images/banner.jpg'); ?>"
