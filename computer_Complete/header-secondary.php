					...
					<div class="col-12 col-md-5">
						<a href="http://localhost/ducthanh">
							<div class="media logo-groups">
								<img src="http://10.10.114.221/ducthanhcomputer/wp-content/themes/ducthanh/images/logo.png"
						...
						<!-- <div class="left-menu">
							<ul id="menu-top-menu" class="left-menu">
								...
								<li id="menu-item-46"
									...
									<a href="http://localhost/ducthanh/category/news/"
										aria-current="page">Tin tức</a></li>
								<li id="menu-item-13"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-13"><a
										href="http://localhost/ducthanh/bao-hanh/">Bảo hành</a></li>
								<li id="menu-item-15"
